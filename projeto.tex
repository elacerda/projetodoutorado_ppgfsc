...
\begin{figure}
	\begin{center}
    \includegraphics[width=1.2\textwidth, angle=-90]{figuras/SFRSD_linregress_report.png}
...
\begin{figure}
	\begin{center}
    \includegraphics[width=0.99\textwidth]{figuras/logtauV_logaSFRSD_age_100Myr.png}
